...
export default function Login(props) {
  ...
  return (
    <div onSubmit={formik.handleSubmit} className="lg:w-1/2 xl:max-w-screen-sm">
    <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
      <div className="cursor-pointer flex items-center">
        ...
        <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Film</div>
      </div>
    </div>
      ...
      <div className="mt-12">
        <form>
          ...
          <div className="mt-8">
            ...
            <input type="password"  name="matKhau" onChange={formik.handleChange}  className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Nhập Mật Khảu" />
          </div>
          <div className="mt-10">
