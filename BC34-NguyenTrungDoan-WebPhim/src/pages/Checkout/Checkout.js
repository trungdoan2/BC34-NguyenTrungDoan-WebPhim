...
export default  function (props)  {
 ...
 return <div className='p-5'>
  <Tabs tabBarExtraContent={operations} defaultActiveKey='1' onChange={callback}>
      <TabPlane tab="01 CHỌN GHẾ & THANH TOÁN" key="1">
          <Checkout {...props} />
      </TabPlane>
      <TabPlane tab="02 KẾT QUẢ ĐẶT VÉ" key="2">
          <KetQuaDatVe {...props} />
      </TabPlane>
  ...
  return thongTinNguoiDung.thongTinDatVe?.map((ticket,index) =>{
    ...
    <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
      ...
      <div className="flex-grow">
        ...
        <p className="text-gray-500"> Giờ chiếu:{moment(ticket.ngayDat).format("hh:mm A ")} <br/> Ngày chiếu:{moment(ticket.ngayDat).format("-DD-MM-YY")}</p>
      </div>
    </div>
  </div>
  })
 ...
 <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-purple-800">Lịch Sử Đặt Vé</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Chúc Bạn Một Buổi Xem Phim Vui Vẻ <br/> Hân Hạnh Được Phục Vụ Quý Khách</p>
    </div>
